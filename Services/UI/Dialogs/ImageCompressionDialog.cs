...
namespace PowerPointEfficiencyAddin.Services.UI.Dialogs
{
    ...
    public partial class ImageCompressionDialog : Form
    {
        ...
        public ImageCompressionDialog(byte[] imageData)
        {
            ...
            // 画像解析を実行
            analysisResult = AnalyzeImage(originalImage);

            // 自動設定を生成
            settings = GenerateAutoSettings(analysisResult);
        ...
        private void InitializeComponent()
        {
            ...
            // フォーム設定（幅と高さを適切に設定）
            Text = "画像圧縮";
            Size = new Size(520, 670); // 高さを650に拡大
        ...
        private ImageAnalysisResult AnalyzeImage(MagickImage image)
        {
            ...
            try
            {
                ...
                result.ColorCount = image.TotalColors;
